# Resources: Electronics (General)

For subcategory-specific resources, always prefer the subcategory `_resources.md` file.
These are fallback resources for electronics that don't have their own subcategory file.

## General Electronics Review Sources

| Source | Best for | URL |
|---|---|---|
| The Wirecutter | Best-overall picks across all consumer electronics | https://www.nytimes.com/wirecutter |
| Tom's Guide | Consumer reviews, how-to guides | https://www.tomsguide.com |
| Digital Trends | Broad coverage, buying guides | https://www.digitaltrends.com |
| CNET | Wide coverage, older but still useful | https://www.cnet.com |
| The Verge | Tech news + reviews | https://www.theverge.com |
| Engadget | News-focused, some reviews | https://www.engadget.com |
